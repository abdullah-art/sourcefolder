...
import './DemoSection1.css'
export default function DemoSection1() {
    const style = {
        "margin-left": "13%",
      };
    
    return (
            <section id="DemoSection1">
                <div className="darrow-up mt-5"></div>
                <div className="container-fluid p-5 bg-primary">
                    ...
                    <form>
                    <div className="form-row w-75 mt-5" style={style}>
                        <div className="form-group col-6 pr-5">
                        <input
                            type="text"
                            className="dinp text-white form-control bg-primary "
                            id="inputFirstName"
                        />
                    ...
                    <a href="#q" className="btn rounded-pill mt-5" id="ddemobtn">
                        Free Demo
                    </a>
                    </div>
                </div>
